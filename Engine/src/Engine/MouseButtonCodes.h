...
#define GE_MOUSE_BUTTON_LAST      HZ_MOUSE_BUTTON_8
#define GE_MOUSE_BUTTON_LEFT      HZ_MOUSE_BUTTON_1
#define GE_MOUSE_BUTTON_RIGHT     HZ_MOUSE_BUTTON_2
#define GE_MOUSE_BUTTON_MIDDLE    HZ_MOUSE_BUTTON_3